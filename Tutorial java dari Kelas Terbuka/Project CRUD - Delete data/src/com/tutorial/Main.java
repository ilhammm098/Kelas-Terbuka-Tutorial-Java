...
//            fiersabesari_2012_1,2012,fiersa besari,media kita,jejak langkah
    ...
    private static void deleteData() throws IOException{
        ...
        //kita ambil input untuk mendelete data
        Scanner terminalInput = new Scanner(System.in);
        System.out.print("\n Masukkan nomor buku yang akan di hapus: ");
        int deleteNum = terminalInput.nextInt();

        // looping untuk membaca tiap baris dan skip data yang akan di delete
        ...
        while (data != null) {
            ...
            if (deleteNum == entryCount) {
                ...
                isDelete = getYesorNo("Apakan anda yakin akan menghapus?");
                isFound = true;
            }
            if(isDelete){
