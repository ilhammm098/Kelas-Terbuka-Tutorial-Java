...
public class Main{
    public static void main(String[] args){
        ...
        //merubah komponen dari String itu tidak bisa .... kenapa?, karena String java itu immutable
        kataChar[0] = 'c';
        System.out.println(Arrays.toString(kataChar));
        ...
        //1. Strin di java itu immuteble
        //2. String yang berada di String poo; itu akan reuseable, memorynya lebih efisien
        //3. membuat sting dengan method baru, maka dia akan dia akan di taro di memory lain bukan
        //di String pool
    }
